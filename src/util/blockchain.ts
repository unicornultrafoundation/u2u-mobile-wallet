...
export const getInAppProvider = async () => {
  try {
    if (providerContent) {return providerContent;}
    const response = await fetch('https://raw.githubusercontent.com/unicornultrafoundation/explorer-assets/refs/heads/master/mobile_config/provider.min.js');
