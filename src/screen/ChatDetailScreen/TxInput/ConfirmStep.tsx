...
const ConfirmStep = ({onNextStep}: {
  ...
  return (
    <View style={[styles.bodyContainer, {backgroundColor: preferenceTheme.background.background}]}>
      <View style={styles.headerContainer}>
        <Text style={[styles.headerText, {flex: 1, textAlign: 'left'}]}>{t('confirmTransactionInfo')}</Text>
      </View>
