...
export const NEWS_BY_CATEGORY_ENDPOINT = `https://uniultra.xyz/api/v1/blog/categories/`
export const FEATURED_NEWS_ENDPOINT = `https://uniultra.xyz/api/v1/feature`
...
export const WALLET_CONNECT_PROJECT_ID = Config.WALLET_CONNECT_PROJECT_ID